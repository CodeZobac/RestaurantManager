  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <Label htmlFor="reservation_date">{t('form.reservationDate')}</Label>
            <Input
              id="reservation_date"
              type="date"
          ...
          <div>
            <Label htmlFor="reservation_time">{t('form.reservationTime')}</Label>
            <Input
              id="reservation_time"
              type="time"
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          ...
          <div>
            <Label htmlFor="special_requests">{t('form.specialRequests')}</Label>
            <textarea
              id="special_requests"
              rows={4}
