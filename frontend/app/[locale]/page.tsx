...
export default function RestaurantLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <DropdownMenu>
                ...
                <DropdownMenuContent
                  align="end"
                  className="bg-white/95 backdrop-blur-md border-gray-200/50 shadow-lg"
                >
                  <DropdownMenuItem
                    onClick={() => router.replace(pathname, { locale: "en" })}
                    className={`cursor-pointer ${
                      locale === "en" ? "bg-orange-100 text-orange-700" : ""
                    }`}
                  >
                    English
                  </DropdownMenuItem>
                  <DropdownMenuItem
                    ...
                    className={`cursor-pointer ${
                      locale === "pt" ? "bg-orange-100 text-orange-700" : ""
                    }`}
                  >
                    Português
                  </DropdownMenuItem>
      ...
      <Widget restaurantId="0cf509fe-501a-4820-aeae-4144027bd6fd" />
